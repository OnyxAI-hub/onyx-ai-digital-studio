      ...
      <div className="container-narrow text-center">
        <AnimatedSection>
          ...
          <h1 className="font-display text-4xl font-bold md:text-5xl tracking-tight">
            Done-For-You <span className="gradient-text">Websites, Media & Automation</span>
          </h1>
          <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
            Use credits for creative requests — or book ONYX for larger websites, automation systems, AI agents, business workflows, and custom builds.
          </p>
        </AnimatedSection>
      </div>
    </section>
