...
export const packages: Package[] = [
  ...
  },
  {
    name: "Business",
    price: 400,
    description: "Professional multi-page website up to 6 pages with the core features to grow your business online.",
    icon: Rocket,
    highlighted: true,
    badge: "Most Popular",
  ...
  },
  {
    name: "Advanced",
    price: 700,
    description: "Top-tier website or web app up to 8 pages with everything in Business plus ecommerce and full automation.",
    icon: Zap,
    cta: "Book a Free Consultation",
    ctaLink: CALENDLY,
