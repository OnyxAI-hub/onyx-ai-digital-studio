...
export const packages: Package[] = [
  ...
  },
  {
    ...
    price: 500,
    pricePrefix: "Starting at",
    description: "AI agent setup for businesses that want a smarter way to answer questions, collect customer details, support calls or chats, and route service requests.",
    icon: PhoneCall,
    cta: "Book a Consultation",
    ctaLink: CALENDLY,
    intakeLink: "/project-intake?package=AI%20Agent",
    supportingNote: "AI agent pricing may vary depending on call volume, platform costs, phone number setup, integrations, and workflow complexity.",
    features: [
      "AI voice or chat agent setup",
      "Custom script / conversation flow",
      "Business FAQ training",
      "Lead capture questions",
      "Service request intake",
      "Call or chat summary workflow",
      "Missed-call support flow if applicable",
